...
import { IonHeader, IonToolbar, IonContent, IonPage, IonButtons, IonMenuButton, IonButton, IonIcon, IonDatetime, IonSelectOption, IonList, IonItem, IonLabel, IonSelect, IonPopover, IonToast } from '@ionic/react';
import './About.scss';
...
const About: React.FC<AboutProps> = () => {
  ...
  return (
    <IonPage id="about-page">
      ...
      {/* <iframe width='100%' height='30%' src="https://www.youtube.com/embed/D164TFHeOcI" allow="autoplay; encrypted-media" allowFullScreen></iframe> */}
    </IonPage>
  );
